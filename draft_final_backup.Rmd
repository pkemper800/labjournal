...
## Degrees - Descriptive Statistics, Radboud Professors 
...
df_ego$collab_total_w1 <- rowSums(test$nets[1,,]) 
df_ego$collab_total_w2 <- rowSums(test$nets[2,,]) 
