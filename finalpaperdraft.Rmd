...
Make sure to include binary variable for gender, as gender is the independent variable that is analyzed in this research. With this, male = 0, and female = 1. 
...
I want to be able to control for the department, so I will create an additional binary variable denoting if the ego/professor is affiliated with sociology (0) or political science (1). This will serve as a constant covariate, looking at EgoX effect per discipline. 
...
# Network Visualizations - Radboud Professors
...
V(test_wave1ru)$size = betweenness(test_wave1ru, normalized = T, directed = TRUE) * 100 + 8  #after some trial and error
...
Current random number seed is 376539.
...
Total of 2620 iterations.
Parameter estimates based on 1620 iterations,
basic rate parameter as well as 
convergence diagnostics, covariance and derivative matrices based on 1000 iterations.

Information for convergence diagnosis.
Averages, standard deviations, and t-ratios for deviations from targets:
  1.   1.3000   7.2743   0.1787 
  2.  -0.4860   4.1213  -0.1179 
  3. 218.9707 540.4946   0.4051 
  4.  -0.6430   4.7556  -0.1352 
  5.  -0.5408   5.3366  -0.1013 

Good convergence is indicated by the t-ratios being close to zero.

Overall maximum convergence ratio =  0.4173 .
...
Rate parameters:
 0. Rate parameter                            2.7065  (   0.5315)

Other parameters:
 1. eval:  outdegree (density)                                    -1.7166  (   1.0115)
 2. eval:  reciprocity                                             1.5285  (   0.5281)
 3. eval:  indegree-popularity (centrd)                            0.4090  (   0.0729)
 4. eval:  network-isolate                                         6.6438  (   2.6391)
 5. eval:  female ego                                              2.0976  (   1.8346)
...
Covariance matrix of estimates (correlations below diagonal):
     1.023      0.038     -0.012      2.537      1.766
     0.072      0.279     -0.002      0.058      0.146
    -0.161     -0.064      0.005     -0.017     -0.004
     0.950      0.041     -0.090      6.965      4.460
     0.952      0.151     -0.030      0.921      3.366
...
myeff = getEffects(mydata)
myeff = includeEffects(myeff, isolateNet, inPop.c)
myeff = includeEffects(myeff, egoX, sameX, interaction1 = "female") # better to include sameX too? 
