...
#need df_scholars dataframe
```



```{r}
df22_soc <- readxl::read_xlsx("C:/Github/labjournal/2022scholarid_jt.xlsx", sheet = 1)
...
Had to comment out all of the following to get to knit 
...
```{r}
#for (i in 1:nrow(df_scholars$demographics)) {
