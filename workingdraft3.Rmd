...
Note: see if it changes things to add other universities + other disciplines** 
UPDATE THIS** 
...
Three waves of data, waves separated per the time they were pulled (will not try to even distribution: just acknowledge the differences in years in analysis).
...
Establishing the dataframes for analysis - a subset from "scholars" with just professors from RU. Will try this before scaling. 
...
# myeff = includeEffects(myeff, egoX, altX, diffX, interaction1 = "female")
...
xgencollab = coCovar(df_ego$female)
